...
<el-table-column align="center" :label="$t(`account['操作']`)" width='250'>
    <template slot-scope="scope">
        ...
        <span class="cap_current" @click='draw(scope.row)' v-if='scope.row.vTotal'>{{$t('account["划出"]')}}</span>
        <span class="cap_no_current" v-if='!scope.row.vTotal'>{{$t('account["划出"]')}}</span>
...
<el-dialog title="内部划账" :visible.sync="dialogFormVisible" width='40%'>
    <div class='included'>
            ...
            <div class="introduce">
                <el-dropdown @command="handleCommand">
                    <div class="el-dropdown-link">
                        ...
                        <i class="el-icon-arrow-down el-icon--right" style="position:absolute;right:0;top:0;z-index:20"></i>
                    </div>
    ...
    <el-form ref="form" :model="included_form" label-width="80px">
        ...
        <el-form-item label="登录密码">
            <el-input v-model="included_form.password" type='password'></el-input>
        </el-form-item>
...
<!--转出到-->
<el-dialog title="内部划账" :visible.sync="draw_dialog" width='40%'>
    <div class='included'>
        <div class="include-item" style="border:2px dashed #d7d9dc">
            <div class="img"></div>
            <div class="introduce">
    ...
    <el-form :model="draw_form" label-width="80px">
        ...
        <el-form-item label="登录密码">
            <el-input v-model="draw_form.password" typr='password'></el-input>
        </el-form-item>
        <el-form-item align='right'>
