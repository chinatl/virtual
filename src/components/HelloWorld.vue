...
<header id="user-nav" class="header">
  <div class="exx-notice"><a class="text">EXX关于变更虚拟币充值地址的公告</a>
    <a title="关闭" class="close"></a>
  </div>
  <div class="h-content">
    <div class="h-box">
      <div class="subscription">
        <router-link to='/'>主页</router-link></p>
      </div>
      <div class="site-menu cart" style="margin-left: 20px; display: none;">
        <p role="button"><a href="/exchange">QC交易</a></p>
      ...
      <div class="subscription" style="margin-left: 20px;">
        <p role="button">
        <router-link to='/transaction'>专业交易</router-link></p>
      </div>
      <div class="subscription" style="margin-left: 20px;">
        <p role="button">
        <router-link to='/ranking'>交易排行榜</router-link></p>
      </div>
    ...
    <div class="h-box">
      <div class='subscription'>
        <router-link to='/subscription'>认购</router-link>
      </div>
      <div class="finance-menu">
        <router-link to='/account'>财务中心</router-link>
      ...
      <div class="user-menu"><router-link to="/login" class="flex flex-tb-center menu-head ">登录</router-link><a href="/register" class="flex flex-tb-center menu-head ">注册</a></div>
      <div class="language">
...
<style>
  ...
  .finance-menu>a:hover,.subscription a:hover,.subscription a.active,
